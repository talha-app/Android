package com.talha.sample.application.sharedpreferences
...
import com.talha.sample.application.sharedpreferences.databinding.ActivitySecondBinding
...
class SecondActivity : AppCompatActivity() {
    ...
    private fun initSharedPrefs() {
        sharedPrefs = getSharedPreferences("activity_settings", MODE_PRIVATE)
